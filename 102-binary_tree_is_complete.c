...
/**
 * new_node - Function to creates a new_node in a linked_list
 * @node: Enter the pointer to the node to create
 * Return: Node created
 */
...
/**
 * free_q - A function that free a nodes in a linked list
...
/**
 * _push - Function to push a node onto the stack
 * @node: Type pointer of the tree's node
 * @head: Enter the head node in the stack
 * @tail: Enter the tail node of on the stack
 */
